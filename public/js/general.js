...
function handleWin(player) {
  ...
  messageModal.classList.remove("redAlert");
  playerWinSound.play();
  messageModal.classList.add("greenAlert");
}
function handleLose(player) {
  ...
  moneySound.play();
  messageModal.classList.remove("hidden");
  messageModal.classList.add("redAlert");
  messageModal.classList.remove("greenAlert");
}
